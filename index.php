<?php
    ...
    queueTrackAnalyzingForUser($userId); // this was commented out to make reloads faster. still havent found a good way to save all your songs to the db at once. 
    die;
